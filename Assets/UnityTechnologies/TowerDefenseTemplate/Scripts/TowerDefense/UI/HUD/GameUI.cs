...
namespace TowerDefense.UI.HUD
{
	...
	public class GameUI : Singleton<GameUI>
	{
		...
		public GenerateQuestionLvl1 generateQuestionLvl1;
		...
		public void SelectTower(Tower tower)
		{
			...
			if (tower.isDisabled)
			{
				Debug.Log("Tower is disabled");
				generateQuestionLvl1.CreateQuestion(tower);
			}
			else
			{
		...
		public void PlaceTower()
		{
            ...
            GameObject towerParent = GameObject.Find("TowerParent");
			//Debug.Log("TowerParent: " + towerParent);
            if (towerParent != null)
            {
				//Debug.Log("TowerParent found");
                createdTower.gameObject.transform.SetParent(towerParent.transform);
            }
